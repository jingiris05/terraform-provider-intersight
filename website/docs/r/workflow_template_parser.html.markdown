...
* `template_content`:(string) The content of the entire template file. The contentcan either be a static or dynamic file that can contain placeholders.The placeholders are expected to conform to the golang template syntax i.e. it must be provided inside {{ }}. 
...
```
$ terraform import intersight_workflow_template_parser.example 1234567890987654321abcde
``` 
