...
* `data`:(JSON as string) Transformation model in yaml format. 
...
## Import
`intersight_partnerintegration_etl` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_partnerintegration_etl.example 1234567890987654321abcde
``` 
