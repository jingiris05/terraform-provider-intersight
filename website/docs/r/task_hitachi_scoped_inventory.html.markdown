...
## Import
`intersight_task_hitachi_scoped_inventory` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_task_hitachi_scoped_inventory.example 1234567890987654321abcde
``` 
