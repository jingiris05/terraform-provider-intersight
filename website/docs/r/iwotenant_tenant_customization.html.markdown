...
* `is_write_user_access_key_id_set`:(bool)(ReadOnly) Indicates whether the value of the 'writeUserAccessKeyId' property has been set. 
* `is_write_user_secret_access_key_set`:(bool)(ReadOnly) Indicates whether the value of the 'writeUserSecretAccessKey' property has been set. 
...
## Import
`intersight_iwotenant_tenant_customization` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_iwotenant_tenant_customization.example 1234567890987654321abcde
``` 
