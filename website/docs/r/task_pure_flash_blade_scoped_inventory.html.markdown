...
subcategory: "task"
layout: "intersight"
page_title: "Intersight: intersight_task_pure_flash_blade_scoped_inventory"
description: |-
...
## Import
`intersight_task_pure_flash_blade_scoped_inventory` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_task_pure_flash_blade_scoped_inventory.example 1234567890987654321abcde
``` 
