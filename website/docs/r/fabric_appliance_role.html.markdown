...
## Import
`intersight_fabric_appliance_role` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_fabric_appliance_role.example 1234567890987654321abcde
``` 
