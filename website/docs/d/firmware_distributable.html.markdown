...
* `is_beta`:(bool) Whether this distributable is a beta image and participates in OData filtering so callers can explicitly query beta or non-beta firmware images. 
