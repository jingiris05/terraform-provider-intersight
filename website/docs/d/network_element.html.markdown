...
* `cdp_enabled`:(bool) Cisco Discovery Protocol configuration for the switch. 
...
* `lldp_enabled`:(bool) Link Layer Discovery Protocol configuration for the switch. 
...
* `switch_wwn`:(string) World Wide Name of the switch. 
