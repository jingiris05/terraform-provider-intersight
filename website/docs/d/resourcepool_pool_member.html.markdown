...
To access the ith object of the results obtained, use `data.intersight_resourcepool_pool_member.<custom_name>.results[i].<propertyname>`.
...
* `reserved`:(bool) Identifies if the member has been reserved. 
