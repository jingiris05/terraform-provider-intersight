...
// checks if the TelemetryDruidInlineDataSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidInlineDataSource{}
...
func (o TelemetryDruidInlineDataSource) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidInlineDataSource) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidInlineDataSource)
