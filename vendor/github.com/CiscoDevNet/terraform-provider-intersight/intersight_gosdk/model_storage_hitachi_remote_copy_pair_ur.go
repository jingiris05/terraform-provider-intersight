...
// StorageHitachiRemoteCopyPairUr The HitachiRemoteCopyPairUr object defines a Universal Replicator pair entity within the Hitachi storage array, supporting replication management and operations. #### Purpose HitachiRemoteCopyPairUr serves as a central component for managing Universal Replicator pairs, facilitating replication operations and monitoring of pair settings. #### Key Concepts - **Replication Management:** Provides settings for replication types, LDEV numbers, and status information for Universal Replicator pairs. - **Privilege Sets:** Ensures secure access and management of replication entities with defined privilege sets. - **Licensing:** Operates under specified entitlements, supporting authorized replication operations.
