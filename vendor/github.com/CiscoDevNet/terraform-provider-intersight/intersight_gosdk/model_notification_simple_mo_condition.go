...
type NotificationSimpleMoCondition struct {
	...
	FilterExpression NullableFilterexprFilterExpression `json:"FilterExpression,omitempty"`
...
// SetFilterExpression gets a reference to the given NullableFilterexprFilterExpression and assigns it to the FilterExpression field.
...
func (o *NotificationSimpleMoCondition) SetFilterExpressionNil() {
...
func (o *NotificationSimpleMoCondition) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varNotificationSimpleMoCondition.FilterExpression = varNotificationSimpleMoConditionWithoutEmbeddedStruct.FilterExpression
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "FilterExpression")
