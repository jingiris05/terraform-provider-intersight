...
// checks if the HyperflexClusterStoragePolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexClusterStoragePolicyList{}
...
func (o HyperflexClusterStoragePolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexClusterStoragePolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexClusterStoragePolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexClusterStoragePolicyList)
	if err == nil {
