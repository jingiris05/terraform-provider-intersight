...
// checks if the CondAlarmDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CondAlarmDefinition{}

// CondAlarmDefinition AlarmDefinition describes alarm messages, including their meaning and recommended recovery actions. It helps identify alarms by providing details such as the alarm name, description, severity, and suggested troubleshooting steps, aiding administrators in managing and responding to system alarms effectively. #### Purpose An AlarmDefinition specifies the conditions under which an alarm is generated and the corresponding actions to be performed. It acts as a blueprint for alarm creation by combining detection logic, descriptive information, and the defined response actions. #### Key Concepts - **Alarm Actions:** Specifies the set of alarms to be raised, including detailed messaging and severity levels, providing a consistent and automated response to detected issues. - **Read-Only Access:** Designed exclusively primarily for consumption, supporting safe and consistent integration with external systems and user interfaces.
...
func (o *CondAlarmDefinition) GetDefaultClassId() interface{} {
...
func (o *CondAlarmDefinition) GetDefaultObjectType() interface{} {
	return "cond.AlarmDefinition"
}
...
func (o CondAlarmDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *CondAlarmDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCondAlarmDefinitionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCondAlarmDefinition)
	if err == nil {
