...
type MetricsConfiguration struct {
	...
	CollectionGranularity *string `json:"CollectionGranularity,omitempty"`
	...
	UserMaxIngestionBytes *int64                         `json:"UserMaxIngestionBytes,omitempty"`
...
// GetCollectionGranularity returns the CollectionGranularity field value if set, zero value otherwise.
func (o *MetricsConfiguration) GetCollectionGranularity() string {
	if o == nil || IsNil(o.CollectionGranularity) {
		var ret string
		return ret
	}
	return *o.CollectionGranularity
}

// GetCollectionGranularityOk returns a tuple with the CollectionGranularity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricsConfiguration) GetCollectionGranularityOk() (*string, bool) {
	if o == nil || IsNil(o.CollectionGranularity) {
		return nil, false
	}
	return o.CollectionGranularity, true
}
...
// SetCollectionGranularity gets a reference to the given string and assigns it to the CollectionGranularity field.
func (o *MetricsConfiguration) SetCollectionGranularity(v string) {
	o.CollectionGranularity = &v
}
...
// GetUserMaxIngestionBytes returns the UserMaxIngestionBytes field value if set, zero value otherwise.
func (o *MetricsConfiguration) GetUserMaxIngestionBytes() int64 {
	if o == nil || IsNil(o.UserMaxIngestionBytes) {
		var ret int64
		return ret
	}
	return *o.UserMaxIngestionBytes
}

// GetUserMaxIngestionBytesOk returns a tuple with the UserMaxIngestionBytes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricsConfiguration) GetUserMaxIngestionBytesOk() (*int64, bool) {
	if o == nil || IsNil(o.UserMaxIngestionBytes) {
		return nil, false
	}
	return o.UserMaxIngestionBytes, true
}
...
// SetUserMaxIngestionBytes gets a reference to the given int64 and assigns it to the UserMaxIngestionBytes field.
func (o *MetricsConfiguration) SetUserMaxIngestionBytes(v int64) {
	o.UserMaxIngestionBytes = &v
}
...
func (o MetricsConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CollectionGranularity) {
		toSerialize["CollectionGranularity"] = o.CollectionGranularity
	}
	if !IsNil(o.Enabled) {
	...
	if !IsNil(o.UserMaxIngestionBytes) {
		toSerialize["UserMaxIngestionBytes"] = o.UserMaxIngestionBytes
	}
	if o.Account.IsSet() {
...
func (o *MetricsConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varMetricsConfiguration.CollectionGranularity = varMetricsConfigurationWithoutEmbeddedStruct.CollectionGranularity
		...
		varMetricsConfiguration.UserMaxIngestionBytes = varMetricsConfigurationWithoutEmbeddedStruct.UserMaxIngestionBytes
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "CollectionGranularity")
		delete(additionalProperties, "Enabled")
		delete(additionalProperties, "Limit")
		delete(additionalProperties, "UserMaxIngestionBytes")
