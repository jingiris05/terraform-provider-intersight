...
// checks if the VirtualizationEsxiCloneCustomSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationEsxiCloneCustomSpec{}
...
// GetDefaultClassId returns the default value "virtualization.EsxiCloneCustomSpec" of the ClassId field.
func (o *VirtualizationEsxiCloneCustomSpec) GetDefaultClassId() interface{} {
	return "virtualization.EsxiCloneCustomSpec"
}
...
// GetDefaultObjectType returns the default value "virtualization.EsxiCloneCustomSpec" of the ObjectType field.
func (o *VirtualizationEsxiCloneCustomSpec) GetDefaultObjectType() interface{} {
	return "virtualization.EsxiCloneCustomSpec"
}
...
func (o VirtualizationEsxiCloneCustomSpec) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationEsxiCloneCustomSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiCloneCustomSpecWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiCloneCustomSpec)
	if err == nil {
