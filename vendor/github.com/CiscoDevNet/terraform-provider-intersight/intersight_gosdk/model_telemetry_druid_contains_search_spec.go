...
// checks if the TelemetryDruidContainsSearchSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidContainsSearchSpec{}
...
func (o TelemetryDruidContainsSearchSpec) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidContainsSearchSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidContainsSearchSpec)
