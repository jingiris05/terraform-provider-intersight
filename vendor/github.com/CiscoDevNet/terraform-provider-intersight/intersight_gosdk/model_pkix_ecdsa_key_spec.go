...
// checks if the PkixEcdsaKeySpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PkixEcdsaKeySpec{}
...
// GetDefaultClassId returns the default value "pkix.EcdsaKeySpec" of the ClassId field.
func (o *PkixEcdsaKeySpec) GetDefaultClassId() interface{} {
	return "pkix.EcdsaKeySpec"
}
...
// GetDefaultObjectType returns the default value "pkix.EcdsaKeySpec" of the ObjectType field.
func (o *PkixEcdsaKeySpec) GetDefaultObjectType() interface{} {
	return "pkix.EcdsaKeySpec"
}
...
func (o PkixEcdsaKeySpec) ToMap() (map[string]interface{}, error) {
...
func (o *PkixEcdsaKeySpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPkixEcdsaKeySpecWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPkixEcdsaKeySpec)
	if err == nil {
