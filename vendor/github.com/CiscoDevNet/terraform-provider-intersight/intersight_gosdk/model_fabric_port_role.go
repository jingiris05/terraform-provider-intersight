...
// checks if the FabricPortRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricPortRole{}
...
func (o *FabricPortRole) SetPortPolicyNil() {
...
func (o FabricPortRole) ToMap() (map[string]interface{}, error) {
...
func (o *FabricPortRole) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricPortRoleWithoutEmbeddedStruct)
	if err == nil {
		...
		varFabricPortRole.UserLabel = varFabricPortRoleWithoutEmbeddedStruct.UserLabel
	...
	err = json.Unmarshal(data, &varFabricPortRole)
	if err == nil {
