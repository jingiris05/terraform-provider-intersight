...
// checks if the AssetDeployment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetDeployment{}

// AssetDeployment The Deployment object is an essential element of the Cisco consumption-based subscription ecosystem, providing detailed information about deployments associated with subscriptions. It ensures seamless integration and updates through Cisco Install Base, supporting effective deployment tracking and management. #### Purpose Deployment serves as a detailed repository for tracking and managing deployments under consumption-based subscriptions, facilitating automated updates and ensuring accurate data representation. This information is also queried by downstream OPUS team for billing purposes.  #### Key Concepts - **Integration:** Automates deployment management through synchronization with Cisco Install Base, ensuring data accuracy. - **Detailed Information:** Provides comprehensive data on deployment status, customer details, and associated metrics. - **Access Management:** Enforces secure access through defined privileges, ensuring only authorized users can interact with deployment data. - **Relationship and Dependency Handling:** Manages complex relationships between deployments, devices, and subscriptions, supporting efficient management. - **Consumption metering Alerts:** It keeps track of  Deployment level consumption based metering related alerts.
...
// GetDefaultClassId returns the default value "asset.Deployment" of the ClassId field.
func (o *AssetDeployment) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "asset.Deployment" of the ObjectType field.
func (o *AssetDeployment) GetDefaultObjectType() interface{} {
	return "asset.Deployment"
}
...
func (o *AssetDeployment) GetDeploymentRefId() string {
	if o == nil || IsNil(o.DeploymentRefId) {
		var ret string
		return ret
	}
...
func (o *AssetDeployment) SetSubscriptionNil() {
...
func (o AssetDeployment) ToMap() (map[string]interface{}, error) {
...
func (o *AssetDeployment) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetDeploymentWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetDeployment)
	if err == nil {
