...
// checks if the FeedbackFeedbackPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeedbackFeedbackPost{}

// FeedbackFeedbackPost The FeedbackPost object serves as the initial entry point for user feedback within the system. This provides a mechanism for users to submit their comments and evaluations directly through the user interface.  #### Purpose Feedback Post enables users to capture and submit first-hand feedback directly from the interface, ensuring that original input is accurately preserved and processed. It supports seamless UI integration, immediate submission, and reliable data retention for effective analysis and response #### Key Concepts - **User-Driven:** Facilitates direct interaction between users and the feedback system, ensuring that user voices are heard and considered. - **Shared Resource:** Functions as a shared organizational resource, accessible across various departments and privilege sets.
...
// GetDefaultClassId returns the default value "feedback.FeedbackPost" of the ClassId field.
func (o *FeedbackFeedbackPost) GetDefaultClassId() interface{} {
	return "feedback.FeedbackPost"
}
...
// GetDefaultObjectType returns the default value "feedback.FeedbackPost" of the ObjectType field.
func (o *FeedbackFeedbackPost) GetDefaultObjectType() interface{} {
	return "feedback.FeedbackPost"
}
...
func (o *FeedbackFeedbackPost) GetFeedbackData() FeedbackFeedbackData {
	if o == nil || IsNil(o.FeedbackData.Get()) {
...
func (o *FeedbackFeedbackPost) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o FeedbackFeedbackPost) ToMap() (map[string]interface{}, error) {
...
func (o *FeedbackFeedbackPost) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFeedbackFeedbackPostWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFeedbackFeedbackPost)
	if err == nil {
