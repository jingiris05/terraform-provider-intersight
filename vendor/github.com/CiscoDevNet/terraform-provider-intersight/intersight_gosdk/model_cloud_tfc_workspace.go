...
// CloudTfcWorkspace The TfcWorkspace object serves as a representation of running infrastructure managed by Terraform.  #### Purpose Intersight discovers the Workspaces in the Terraform Cloud account whose credentials are specified in the Terraform Cloud target. #### Key Concepts - **Infrastructure Representation:** Represents an active Terraform-managed environment, encapsulating configuration, state, and execution history. - **Credential-Based Discovery:** Intersight automatically discovers Terraform Cloud workspaces using the credentials defined in the Terraform Cloud target.
...
// GetDefaultClassId returns the default value "cloud.TfcWorkspace" of the ClassId field.
func (o *CloudTfcWorkspace) GetDefaultClassId() interface{} {
	return "cloud.TfcWorkspace"
}
...
// GetDefaultObjectType returns the default value "cloud.TfcWorkspace" of the ObjectType field.
func (o *CloudTfcWorkspace) GetDefaultObjectType() interface{} {
	return "cloud.TfcWorkspace"
}
