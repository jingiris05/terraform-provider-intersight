...
// checks if the VnicEthTxQueueSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicEthTxQueueSettings{}
...
// GetDefaultClassId returns the default value "vnic.EthTxQueueSettings" of the ClassId field.
func (o *VnicEthTxQueueSettings) GetDefaultClassId() interface{} {
	return "vnic.EthTxQueueSettings"
}
...
// GetDefaultObjectType returns the default value "vnic.EthTxQueueSettings" of the ObjectType field.
func (o *VnicEthTxQueueSettings) GetDefaultObjectType() interface{} {
	return "vnic.EthTxQueueSettings"
}
...
func (o VnicEthTxQueueSettings) ToMap() (map[string]interface{}, error) {
...
func (o *VnicEthTxQueueSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicEthTxQueueSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicEthTxQueueSettings)
	if err == nil {
