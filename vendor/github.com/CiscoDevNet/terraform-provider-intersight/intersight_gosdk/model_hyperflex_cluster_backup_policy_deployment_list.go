...
// checks if the HyperflexClusterBackupPolicyDeploymentList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexClusterBackupPolicyDeploymentList{}
...
func (o HyperflexClusterBackupPolicyDeploymentList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexClusterBackupPolicyDeploymentList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexClusterBackupPolicyDeploymentListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexClusterBackupPolicyDeploymentList)
	if err == nil {
