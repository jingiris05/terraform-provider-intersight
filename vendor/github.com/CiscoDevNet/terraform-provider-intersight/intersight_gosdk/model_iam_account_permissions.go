...
// checks if the IamAccountPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamAccountPermissions{}
...
type IamAccountPermissions struct {
	...
	AccountPermissionTags []IamAccountTags `json:"AccountPermissionTags,omitempty"`
...
// GetDefaultClassId returns the default value "iam.AccountPermissions" of the ClassId field.
func (o *IamAccountPermissions) GetDefaultClassId() interface{} {
	return "iam.AccountPermissions"
}
...
// GetDefaultObjectType returns the default value "iam.AccountPermissions" of the ObjectType field.
func (o *IamAccountPermissions) GetDefaultObjectType() interface{} {
	return "iam.AccountPermissions"
}
...
// GetAccountPermissionTags returns the AccountPermissionTags field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IamAccountPermissions) GetAccountPermissionTags() []IamAccountTags {
	if o == nil {
		var ret []IamAccountTags
		return ret
	}
	return o.AccountPermissionTags
}

// GetAccountPermissionTagsOk returns a tuple with the AccountPermissionTags field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamAccountPermissions) GetAccountPermissionTagsOk() ([]IamAccountTags, bool) {
	if o == nil || IsNil(o.AccountPermissionTags) {
		return nil, false
	}
	return o.AccountPermissionTags, true
}
...
// SetAccountPermissionTags gets a reference to the given []IamAccountTags and assigns it to the AccountPermissionTags field.
func (o *IamAccountPermissions) SetAccountPermissionTags(v []IamAccountTags) {
	o.AccountPermissionTags = v
}
...
func (o IamAccountPermissions) ToMap() (map[string]interface{}, error) {
	...
	if o.AccountPermissionTags != nil {
		toSerialize["AccountPermissionTags"] = o.AccountPermissionTags
	}
	if !IsNil(o.AccountStatus) {
		toSerialize["AccountStatus"] = o.AccountStatus
	}
	if !IsNil(o.HomeRegion) {
		toSerialize["HomeRegion"] = o.HomeRegion
	}
...
func (o *IamAccountPermissions) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamAccountPermissionsWithoutEmbeddedStruct)
	if err == nil {
		...
		varIamAccountPermissions.AccountPermissionTags = varIamAccountPermissionsWithoutEmbeddedStruct.AccountPermissionTags
		varIamAccountPermissions.AccountStatus = varIamAccountPermissionsWithoutEmbeddedStruct.AccountStatus
		varIamAccountPermissions.HomeRegion = varIamAccountPermissionsWithoutEmbeddedStruct.HomeRegion
	...
	err = json.Unmarshal(data, &varIamAccountPermissions)
	if err == nil {
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "AccountPermissionTags")
		delete(additionalProperties, "AccountStatus")
		delete(additionalProperties, "HomeRegion")
