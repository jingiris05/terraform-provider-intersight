...
// ServerProfile The Profile object represents a server profile, specifying configuration settings for a physical server. It encapsulates all necessary information to deploy, manage, and monitor a server within the infrastructure. #### Purpose A Profile is used to apply detailed configuration and policy settings to an individual server, supporting lifecycle management, compliance, and automation. #### Key Concepts - **Configuration Management:** Centralizes all relevant configuration states, changes, and compliance results for the server. - **Policy Attachment:** Associates various policies and pools (such as UUID pools and resource pools) to define operational parameters. - **Assignment and Deployment:** Supports both static and dynamic assignment of physical servers, as well as monitoring deployment status and results. - **Lifecycle Tracking:** Integrates with workflow engines and maintains audit trails for configuration changes and applied policies.
type ServerProfile struct {
	...
	InitialAutoDeployConfigComplete *bool `json:"InitialAutoDeployConfigComplete,omitempty"`
	// Automatically performs an initial deployment when a server is assigned. Subsequent changes require manual redeployment.
	InitialAutoDeployMode *bool `json:"InitialAutoDeployMode,omitempty"`
	...
	InitialAutoDeployState        *string                    `json:"InitialAutoDeployState,omitempty"`
	...
	ScheduledServerAssignment   NullableServerServerAssignment `json:"ScheduledServerAssignment,omitempty"`
	...
	ServerReservation       *ResourcepoolReservationReference  `json:"ServerReservation,omitempty"`
	...
	UndeployWfTasks    []string `json:"UndeployWfTasks,omitempty"`
...
func NewServerProfile(classId string, objectType string) *ServerProfile {
	...
	this.Action = &action
	var serverFamily string = "Unspecified"
...
// GetInitialAutoDeployConfigComplete returns the InitialAutoDeployConfigComplete field value if set, zero value otherwise.
func (o *ServerProfile) GetInitialAutoDeployConfigComplete() bool {
	if o == nil || IsNil(o.InitialAutoDeployConfigComplete) {
		var ret bool
		return ret
	}
	return *o.InitialAutoDeployConfigComplete
}

// GetInitialAutoDeployConfigCompleteOk returns a tuple with the InitialAutoDeployConfigComplete field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerProfile) GetInitialAutoDeployConfigCompleteOk() (*bool, bool) {
	if o == nil || IsNil(o.InitialAutoDeployConfigComplete) {
		return nil, false
	}
	return o.InitialAutoDeployConfigComplete, true
}
...
// SetInitialAutoDeployConfigComplete gets a reference to the given bool and assigns it to the InitialAutoDeployConfigComplete field.
func (o *ServerProfile) SetInitialAutoDeployConfigComplete(v bool) {
	o.InitialAutoDeployConfigComplete = &v
}

// GetInitialAutoDeployMode returns the InitialAutoDeployMode field value if set, zero value otherwise.
func (o *ServerProfile) GetInitialAutoDeployMode() bool {
	if o == nil || IsNil(o.InitialAutoDeployMode) {
		var ret bool
		return ret
	}
	return *o.InitialAutoDeployMode
}

// GetInitialAutoDeployModeOk returns a tuple with the InitialAutoDeployMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerProfile) GetInitialAutoDeployModeOk() (*bool, bool) {
	if o == nil || IsNil(o.InitialAutoDeployMode) {
		return nil, false
	}
	return o.InitialAutoDeployMode, true
}
...
// SetInitialAutoDeployMode gets a reference to the given bool and assigns it to the InitialAutoDeployMode field.
func (o *ServerProfile) SetInitialAutoDeployMode(v bool) {
	o.InitialAutoDeployMode = &v
}

// GetInitialAutoDeployState returns the InitialAutoDeployState field value if set, zero value otherwise.
func (o *ServerProfile) GetInitialAutoDeployState() string {
	if o == nil || IsNil(o.InitialAutoDeployState) {
		var ret string
		return ret
	}
	return *o.InitialAutoDeployState
}

// GetInitialAutoDeployStateOk returns a tuple with the InitialAutoDeployState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerProfile) GetInitialAutoDeployStateOk() (*string, bool) {
	if o == nil || IsNil(o.InitialAutoDeployState) {
		return nil, false
	}
	return o.InitialAutoDeployState, true
}
...
// SetInitialAutoDeployState gets a reference to the given string and assigns it to the InitialAutoDeployState field.
func (o *ServerProfile) SetInitialAutoDeployState(v string) {
	o.InitialAutoDeployState = &v
}
...
// GetScheduledServerAssignment returns the ScheduledServerAssignment field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ServerProfile) GetScheduledServerAssignment() ServerServerAssignment {
	if o == nil || IsNil(o.ScheduledServerAssignment.Get()) {
		var ret ServerServerAssignment
		return ret
	}
	return *o.ScheduledServerAssignment.Get()
}

// GetScheduledServerAssignmentOk returns a tuple with the ScheduledServerAssignment field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServerProfile) GetScheduledServerAssignmentOk() (*ServerServerAssignment, bool) {
	...
	return o.ScheduledServerAssignment.Get(), o.ScheduledServerAssignment.IsSet()
}
...
func (o *ServerProfile) HasScheduledServerAssignment() bool {
	if o != nil && o.ScheduledServerAssignment.IsSet() {
		return true
	}
...
// SetScheduledServerAssignment gets a reference to the given NullableServerServerAssignment and assigns it to the ScheduledServerAssignment field.
func (o *ServerProfile) SetScheduledServerAssignment(v ServerServerAssignment) {
	o.ScheduledServerAssignment.Set(&v)
}

// SetScheduledServerAssignmentNil sets the value for ScheduledServerAssignment to be an explicit nil
func (o *ServerProfile) SetScheduledServerAssignmentNil() {
	o.ScheduledServerAssignment.Set(nil)
}
...
func (o *ServerProfile) UnsetScheduledServerAssignment() {
	o.ScheduledServerAssignment.Unset()
}
...
// GetServerReservation returns the ServerReservation field value if set, zero value otherwise.
func (o *ServerProfile) GetServerReservation() ResourcepoolReservationReference {
	if o == nil || IsNil(o.ServerReservation) {
		var ret ResourcepoolReservationReference
		return ret
	}
	return *o.ServerReservation
}

// GetServerReservationOk returns a tuple with the ServerReservation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerProfile) GetServerReservationOk() (*ResourcepoolReservationReference, bool) {
	if o == nil || IsNil(o.ServerReservation) {
		return nil, false
	}
	return o.ServerReservation, true
}
...
// SetServerReservation gets a reference to the given ResourcepoolReservationReference and assigns it to the ServerReservation field.
func (o *ServerProfile) SetServerReservation(v ResourcepoolReservationReference) {
	o.ServerReservation = &v
}
...
// GetUndeployWfTasks returns the UndeployWfTasks field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ServerProfile) GetUndeployWfTasks() []string {
	if o == nil {
		var ret []string
		return ret
	}
	return o.UndeployWfTasks
}

// GetUndeployWfTasksOk returns a tuple with the UndeployWfTasks field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServerProfile) GetUndeployWfTasksOk() ([]string, bool) {
	if o == nil || IsNil(o.UndeployWfTasks) {
		return nil, false
	}
	return o.UndeployWfTasks, true
}
...
// SetUndeployWfTasks gets a reference to the given []string and assigns it to the UndeployWfTasks field.
...
func (o ServerProfile) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InitialAutoDeployConfigComplete) {
		toSerialize["InitialAutoDeployConfigComplete"] = o.InitialAutoDeployConfigComplete
	}
	if !IsNil(o.InitialAutoDeployMode) {
		toSerialize["InitialAutoDeployMode"] = o.InitialAutoDeployMode
	}
	if !IsNil(o.InitialAutoDeployState) {
		toSerialize["InitialAutoDeployState"] = o.InitialAutoDeployState
	}
	...
	if o.ScheduledServerAssignment.IsSet() {
		toSerialize["ScheduledServerAssignment"] = o.ScheduledServerAssignment.Get()
	}
	...
	if !IsNil(o.ServerReservation) {
		toSerialize["ServerReservation"] = o.ServerReservation
	}
	...
	if o.UndeployWfTasks != nil {
		toSerialize["UndeployWfTasks"] = o.UndeployWfTasks
	}
...
func (o *ServerProfile) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varServerProfile.InitialAutoDeployConfigComplete = varServerProfileWithoutEmbeddedStruct.InitialAutoDeployConfigComplete
		varServerProfile.InitialAutoDeployMode = varServerProfileWithoutEmbeddedStruct.InitialAutoDeployMode
		varServerProfile.InitialAutoDeployState = varServerProfileWithoutEmbeddedStruct.InitialAutoDeployState
		...
		varServerProfile.ScheduledServerAssignment = varServerProfileWithoutEmbeddedStruct.ScheduledServerAssignment
		...
		varServerProfile.ServerReservation = varServerProfileWithoutEmbeddedStruct.ServerReservation
		...
		varServerProfile.UndeployWfTasks = varServerProfileWithoutEmbeddedStruct.UndeployWfTasks
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "InitialAutoDeployConfigComplete")
		delete(additionalProperties, "InitialAutoDeployMode")
		delete(additionalProperties, "InitialAutoDeployState")
		...
		delete(additionalProperties, "ScheduledServerAssignment")
		...
		delete(additionalProperties, "ServerReservation")
		...
		delete(additionalProperties, "UndeployWfTasks")
