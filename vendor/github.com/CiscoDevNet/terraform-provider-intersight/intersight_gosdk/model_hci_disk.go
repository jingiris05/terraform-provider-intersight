...
// HciDisk The physical disk belonging to a node in a Nutanix cluster. #### Purpose The Disk object provides a detailed view of disk configurations. #### Key Concepts - **Configuration Details:** Offers insights into disk attributes like storage tier, size, model, and status. - **Operational Status:** Monitors disk operational state and storage utilization.
type HciDisk struct {
	MoBaseMo
