...
// HciLicense The License object captures the details of software licenses acquired by Nutanix Prism Central. This provides a structured representation of licenses for all entities managed by Prism Central. #### Purpose   The License object provides a detailed view of license information and status. #### Key Concepts  - **License Representation:** Stores structured information about licenses acquired by Prism Central, including type, status, and validity details. - **Compliance Tracking:** Provides information on license usage and expiration.
