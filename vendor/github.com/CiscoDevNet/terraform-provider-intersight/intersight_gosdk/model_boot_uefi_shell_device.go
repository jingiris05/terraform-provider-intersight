...
// GetDefaultClassId returns the default value "boot.UefiShellDevice" of the ClassId field.
func (o *BootUefiShellDevice) GetDefaultClassId() interface{} {
	return "boot.UefiShellDevice"
}
...
// GetDefaultObjectType returns the default value "boot.UefiShellDevice" of the ObjectType field.
func (o *BootUefiShellDevice) GetDefaultObjectType() interface{} {
	return "boot.UefiShellDevice"
}
...
func (o *BootUefiShellDevice) SetComputePhysicalNil() {
...
func (o *BootUefiShellDevice) SetInventoryDeviceInfoNil() {
...
func (o *BootUefiShellDevice) SetRegisteredDeviceNil() {
...
func (o BootUefiShellDevice) ToMap() (map[string]interface{}, error) {
...
func (o *BootUefiShellDevice) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootUefiShellDeviceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBootUefiShellDevice)
	if err == nil {
