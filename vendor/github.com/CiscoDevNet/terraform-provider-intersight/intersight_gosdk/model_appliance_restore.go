...
// GetDefaultClassId returns the default value "appliance.Restore" of the ClassId field.
func (o *ApplianceRestore) GetDefaultClassId() interface{} {
	return "appliance.Restore"
}
...
// GetDefaultObjectType returns the default value "appliance.Restore" of the ObjectType field.
func (o *ApplianceRestore) GetDefaultObjectType() interface{} {
	return "appliance.Restore"
}
...
func (o *ApplianceRestore) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o ApplianceRestore) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceRestore) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceRestoreWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceRestore)
	if err == nil {
