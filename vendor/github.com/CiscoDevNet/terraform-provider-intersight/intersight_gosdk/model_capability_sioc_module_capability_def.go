...
// checks if the CapabilitySiocModuleCapabilityDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilitySiocModuleCapabilityDef{}
...
// GetDefaultClassId returns the default value "capability.SiocModuleCapabilityDef" of the ClassId field.
func (o *CapabilitySiocModuleCapabilityDef) GetDefaultClassId() interface{} {
	return "capability.SiocModuleCapabilityDef"
}
...
// GetDefaultObjectType returns the default value "capability.SiocModuleCapabilityDef" of the ObjectType field.
func (o *CapabilitySiocModuleCapabilityDef) GetDefaultObjectType() interface{} {
	return "capability.SiocModuleCapabilityDef"
}
...
func (o CapabilitySiocModuleCapabilityDef) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilitySiocModuleCapabilityDef) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilitySiocModuleCapabilityDefWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilitySiocModuleCapabilityDef)
	if err == nil {
