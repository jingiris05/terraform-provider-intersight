...
// IaasCustomTaskInfo The CustomTaskInfo object offers insights into the execution of custom tasks within UCS Director (UCSD), supporting workflow customization and management.   #### Purpose   CustomTaskInfo documents execution details of custom tasks, aiding in workflow personalization and optimization.   #### Key Concepts  - **Custom Task Execution:** Tracks execution of custom tasks, supporting process customization and refinement.  - **Read-Only Access:** Ensures secure access to custom task data without alteration.
