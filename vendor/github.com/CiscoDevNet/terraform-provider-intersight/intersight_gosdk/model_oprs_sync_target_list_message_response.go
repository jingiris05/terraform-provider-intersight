...
func OprsSyncTargetListMessageListAsOprsSyncTargetListMessageResponse(v *OprsSyncTargetListMessageList) OprsSyncTargetListMessageResponse {
	return OprsSyncTargetListMessageResponse{
		OprsSyncTargetListMessageList: v,
	}
}
...
func (dst *OprsSyncTargetListMessageResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal OprsSyncTargetListMessageResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal OprsSyncTargetListMessageResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal OprsSyncTargetListMessageResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'oprs.SyncTargetListMessage.List'
	if jsonDict["ObjectType"] == "oprs.SyncTargetListMessage.List" {
		// try to unmarshal JSON data into OprsSyncTargetListMessageList
		err = json.Unmarshal(data, &dst.OprsSyncTargetListMessageList)
		if err == nil {
			return nil // data stored in dst.OprsSyncTargetListMessageList, return on the first match
		} else {
			dst.OprsSyncTargetListMessageList = nil
			return fmt.Errorf("failed to unmarshal OprsSyncTargetListMessageResponse as OprsSyncTargetListMessageList: %s", err.Error())
		}
	}
...
func (src OprsSyncTargetListMessageResponse) MarshalJSON() ([]byte, error) {
	...
	if src.OprsSyncTargetListMessageList != nil {
		return json.Marshal(&src.OprsSyncTargetListMessageList)
	}
...
func (obj *OprsSyncTargetListMessageResponse) GetActualInstance() interface{} {
	...
	if obj.OprsSyncTargetListMessageList != nil {
		return obj.OprsSyncTargetListMessageList
	}
...
type NullableOprsSyncTargetListMessageResponse struct {
	value *OprsSyncTargetListMessageResponse
	isSet bool
}

func (v NullableOprsSyncTargetListMessageResponse) Get() *OprsSyncTargetListMessageResponse {
	return v.value
}

func (v *NullableOprsSyncTargetListMessageResponse) Set(val *OprsSyncTargetListMessageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOprsSyncTargetListMessageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOprsSyncTargetListMessageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOprsSyncTargetListMessageResponse(val *OprsSyncTargetListMessageResponse) *NullableOprsSyncTargetListMessageResponse {
	return &NullableOprsSyncTargetListMessageResponse{value: val, isSet: true}
}

func (v NullableOprsSyncTargetListMessageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOprsSyncTargetListMessageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
