...
// GetDefaultClassId returns the default value "bulk.HttpHeader" of the ClassId field.
func (o *BulkHttpHeader) GetDefaultClassId() interface{} {
	return "bulk.HttpHeader"
}
...
// GetDefaultObjectType returns the default value "bulk.HttpHeader" of the ObjectType field.
func (o *BulkHttpHeader) GetDefaultObjectType() interface{} {
	return "bulk.HttpHeader"
}
...
func (o BulkHttpHeader) ToMap() (map[string]interface{}, error) {
...
func (o *BulkHttpHeader) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBulkHttpHeaderWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBulkHttpHeader)
	if err == nil {
