...
// PartnerintegrationLogs The Logs object captures the standard output and error logs generated during the build operation of an inventory collection. #### Purpose Similar to `DcLogs`, this object provides detailed logs for inventory build processes, enabling troubleshooting of build failures or performance issues. #### Key Concepts - **Build Visibility:** Tracks `stdout` and `stderr` for inventory build operations. - **Stage-Based Logging:** Categorizes logs by build stage (e.g., Backend, UI, Apidocs) to simplify debugging.
