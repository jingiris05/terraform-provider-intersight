...
// HyperflexIscsiNetwork ### Overview The IscsiNetwork object represents the iSCSI network configuration within the HyperFlex storage system. This provides a detailed interface for managing network settings, including IP ranges, VLAN configuration, and gateway settings, supporting effective storage network operations. #### Purpose An IscsiNetwork serves as a key entity within the HyperFlex storage framework, enabling the organized management of iSCSI network resources and settings. #### Key Concepts - **Configuration Management:** - Manages network settings, including IP address ranges and VLAN configuration, supporting efficient storage network operations. - **Inventory Tracking:** - Provides detailed inventory information, ensuring accurate and reliable network resource management. - **Cluster Integration:** - Integrated with the HyperFlex Cluster, enabling seamless interaction and coordination of storage network resources.
