...
// IaasUcsdManagedInfra The UcsdManagedInfra object is critical for overseeing UCS Director (UCSD) managed infrastructure, providing statistics and insights into managed resources. #### Purpose UcsdManagedInfra offers a detailed view of infrastructure components managed by UCSD, supporting effective resource management and planning. #### Key Concepts - **Infrastructure Statistics:** Captures data on infrastructure components like hosts and virtual machines, aiding in system oversight.  - **Resource Management:** Provides insights into user accounts and groups, supporting efficient resource allocation.  - **Read-Only Access:** Ensures infrastructure data is available for review without modification.
...
// GetDefaultClassId returns the default value "iaas.UcsdManagedInfra" of the ClassId field.
func (o *IaasUcsdManagedInfra) GetDefaultClassId() interface{} {
	return "iaas.UcsdManagedInfra"
}
...
// GetDefaultObjectType returns the default value "iaas.UcsdManagedInfra" of the ObjectType field.
func (o *IaasUcsdManagedInfra) GetDefaultObjectType() interface{} {
	return "iaas.UcsdManagedInfra"
}
