...
// checks if the WorkflowWorkflowEngineProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowWorkflowEngineProperties{}
...
func (o WorkflowWorkflowEngineProperties) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowWorkflowEngineProperties) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowWorkflowEnginePropertiesWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowWorkflowEngineProperties)
	if err == nil {
