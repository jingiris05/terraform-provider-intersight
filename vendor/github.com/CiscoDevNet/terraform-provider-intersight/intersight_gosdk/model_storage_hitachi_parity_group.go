...
// StorageHitachiParityGroup The HitachiParityGroup object defines a parity group within the Hitachi storage array, encapsulating key attributes related to disk configurations and settings. #### Purpose HitachiParityGroup serves as the foundational element for managing parity groups, supporting operations related to disk types, speeds, and compression settings. #### Key Concepts - **Disk Management:** Manages disk types, speeds, and settings related to accelerated compression and encryption. - **Privilege Sets:** Provides controlled access for managing parity group settings with defined privilege sets. - **Licensing:** Ensures operations are performed under specified entitlements, adhering to licensing requirements.
