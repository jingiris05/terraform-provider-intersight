...
func (o *FirmwareDistributable) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFirmwareDistributable.FeatureFlags = varFirmwareDistributableWithoutEmbeddedStruct.FeatureFlags
		...
		varFirmwareDistributable.IsBeta = varFirmwareDistributableWithoutEmbeddedStruct.IsBeta
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "IsBeta")
