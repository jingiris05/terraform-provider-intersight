...
type MemoryPersistentMemoryLogicalNamespace struct {
	...
	Name *string `json:"Name,omitempty" validate:"regexp=^[a-zA-Z0-9#_-][a-zA-Z0-9#_ -]*$"`
...
// GetDefaultClassId returns the default value "memory.PersistentMemoryLogicalNamespace" of the ClassId field.
func (o *MemoryPersistentMemoryLogicalNamespace) GetDefaultClassId() interface{} {
	return "memory.PersistentMemoryLogicalNamespace"
}
...
// GetDefaultObjectType returns the default value "memory.PersistentMemoryLogicalNamespace" of the ObjectType field.
func (o *MemoryPersistentMemoryLogicalNamespace) GetDefaultObjectType() interface{} {
	return "memory.PersistentMemoryLogicalNamespace"
}
