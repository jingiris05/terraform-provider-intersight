...
// checks if the RecoveryBackupSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryBackupSchedule{}

// RecoveryBackupSchedule Backup settings for user defined scheduling on endpoint.
type RecoveryBackupSchedule struct {
	...
	// Backup schedule frequency. * `Daily` - Daily backup scheduling option. * `Periodic` - Hourly backup scheduling option.
	FrequencyUnit *string `json:"FrequencyUnit,omitempty"`
	// Back schedule frequency (in hours). * `8` - The backup interval is 8 hours. * `4` - The backup interval is 4 hours. * `12` - The backup interval is 12 hours. * `16` - The backup interval is 16 hours. * `20` - The backup interval is 20 hours.
...
// GetDefaultClassId returns the default value "recovery.BackupSchedule" of the ClassId field.
func (o *RecoveryBackupSchedule) GetDefaultClassId() interface{} {
	return "recovery.BackupSchedule"
}
...
// GetDefaultObjectType returns the default value "recovery.BackupSchedule" of the ObjectType field.
func (o *RecoveryBackupSchedule) GetDefaultObjectType() interface{} {
	return "recovery.BackupSchedule"
}
...
func (o *RecoveryBackupSchedule) GetFrequencyUnit() string {
	if o == nil || IsNil(o.FrequencyUnit) {
		var ret string
		return ret
	}
...
func (o RecoveryBackupSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryBackupSchedule) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRecoveryBackupScheduleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varRecoveryBackupSchedule)
	if err == nil {
