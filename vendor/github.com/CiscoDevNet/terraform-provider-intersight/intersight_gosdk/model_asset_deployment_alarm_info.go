...
// checks if the AssetDeploymentAlarmInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetDeploymentAlarmInfo{}
...
// GetDefaultClassId returns the default value "asset.DeploymentAlarmInfo" of the ClassId field.
func (o *AssetDeploymentAlarmInfo) GetDefaultClassId() interface{} {
	return "asset.DeploymentAlarmInfo"
}
...
// GetDefaultObjectType returns the default value "asset.DeploymentAlarmInfo" of the ObjectType field.
func (o *AssetDeploymentAlarmInfo) GetDefaultObjectType() interface{} {
	return "asset.DeploymentAlarmInfo"
}
...
func (o AssetDeploymentAlarmInfo) ToMap() (map[string]interface{}, error) {
...
func (o *AssetDeploymentAlarmInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetDeploymentAlarmInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetDeploymentAlarmInfo)
	if err == nil {
