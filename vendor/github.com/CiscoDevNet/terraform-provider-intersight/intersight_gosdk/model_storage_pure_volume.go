...
type StoragePureVolume struct {
	...
	// Nutanix disk UUID (extId) from owner_disk_id tag value.
	NxVmDiskId *string `json:"NxVmDiskId,omitempty"`
	// Nutanix VM UUID (extId) from owner_id tag value.
	NxVmId *string `json:"NxVmId,omitempty"`
...
// GetDefaultClassId returns the default value "storage.PureVolume" of the ClassId field.
func (o *StoragePureVolume) GetDefaultClassId() interface{} {
	return "storage.PureVolume"
}
...
// GetDefaultObjectType returns the default value "storage.PureVolume" of the ObjectType field.
func (o *StoragePureVolume) GetDefaultObjectType() interface{} {
	return "storage.PureVolume"
}
...
// GetNxVmDiskId returns the NxVmDiskId field value if set, zero value otherwise.
func (o *StoragePureVolume) GetNxVmDiskId() string {
	if o == nil || IsNil(o.NxVmDiskId) {
		var ret string
		return ret
	}
	return *o.NxVmDiskId
...
// GetNxVmDiskIdOk returns a tuple with the NxVmDiskId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StoragePureVolume) GetNxVmDiskIdOk() (*string, bool) {
	if o == nil || IsNil(o.NxVmDiskId) {
		return nil, false
	}
	return o.NxVmDiskId, true
}
...
// SetNxVmDiskId gets a reference to the given string and assigns it to the NxVmDiskId field.
func (o *StoragePureVolume) SetNxVmDiskId(v string) {
	o.NxVmDiskId = &v
}

// GetNxVmId returns the NxVmId field value if set, zero value otherwise.
func (o *StoragePureVolume) GetNxVmId() string {
	if o == nil || IsNil(o.NxVmId) {
		var ret string
		return ret
	}
	return *o.NxVmId
...
// GetNxVmIdOk returns a tuple with the NxVmId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StoragePureVolume) GetNxVmIdOk() (*string, bool) {
	if o == nil || IsNil(o.NxVmId) {
		return nil, false
	}
	return o.NxVmId, true
}
...
// SetNxVmId gets a reference to the given string and assigns it to the NxVmId field.
...
func (o StoragePureVolume) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NxVmDiskId) {
		toSerialize["NxVmDiskId"] = o.NxVmDiskId
	}
	if !IsNil(o.NxVmId) {
		toSerialize["NxVmId"] = o.NxVmId
	}
	if !IsNil(o.PodName) {
...
func (o *StoragePureVolume) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varStoragePureVolume.NxVmDiskId = varStoragePureVolumeWithoutEmbeddedStruct.NxVmDiskId
		varStoragePureVolume.NxVmId = varStoragePureVolumeWithoutEmbeddedStruct.NxVmId
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "NxVmDiskId")
		delete(additionalProperties, "NxVmId")
