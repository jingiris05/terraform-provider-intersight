...
// checks if the EquipmentSystemIoControllerList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EquipmentSystemIoControllerList{}
...
func (o EquipmentSystemIoControllerList) ToMap() (map[string]interface{}, error) {
...
func (o *EquipmentSystemIoControllerList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEquipmentSystemIoControllerListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varEquipmentSystemIoControllerList)
	if err == nil {
