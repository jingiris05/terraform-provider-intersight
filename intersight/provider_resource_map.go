...
func GetResourceMapping() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"intersight_appliance_cluster_worker_node":                           resourceApplianceClusterWorkerNode(),
		"intersight_appliance_cluster_worker_node_replace":                   resourceApplianceClusterWorkerNodeReplace(),
		"intersight_appliance_cluster_worker_node_reuse":                     resourceApplianceClusterWorkerNodeReuse(),
		...
		"intersight_asset_claim_token":                                       resourceAssetClaimToken(),
		...
		"intersight_asset_geo_location":                                      resourceAssetGeoLocation(),
		"intersight_asset_pre_claim":                                         resourceAssetPreClaim(),
		"intersight_asset_target":                                            resourceAssetTarget(),
		"intersight_auditd_policy":                                           resourceAuditdPolicy(),
		...
		"intersight_chassis_profile_template":                                resourceChassisProfileTemplate(),
		"intersight_cli_cli_policy":                                          resourceCliCliPolicy(),
		...
		"intersight_comm_tag_definition":                                     resourceCommTagDefinition(),
		"intersight_compute_host_utility_operation":                          resourceComputeHostUtilityOperation(),
		"intersight_compute_pcie_connectivity_policy":                        resourceComputePcieConnectivityPolicy(),
		"intersight_compute_scrub_policy":                                    resourceComputeScrubPolicy(),
		"intersight_cond_alarm_rule":                                         resourceCondAlarmRule(),
		"intersight_cond_alarm_suppression":                                  resourceCondAlarmSuppression(),
		"intersight_cond_alarm_suppression_dry_run":                          resourceCondAlarmSuppressionDryRun(),
		"intersight_cond_custom_hcl_baseline":                                resourceCondCustomHclBaseline(),
		"intersight_cond_custom_hcl_status":                                  resourceCondCustomHclStatus(),
		"intersight_cond_hcl_status_job":                                     resourceCondHclStatusJob(),
		"intersight_cond_threshold_definition":                               resourceCondThresholdDefinition(),
		...
		"intersight_energy_daily_metrics":                                    resourceEnergyDailyMetrics(),
		"intersight_energy_metrics":                                          resourceEnergyMetrics(),
		...
		"intersight_fabric_net_flow_exporter":                                resourceFabricNetFlowExporter(),
		"intersight_fabric_net_flow_monitor":                                 resourceFabricNetFlowMonitor(),
		"intersight_fabric_net_flow_policy":                                  resourceFabricNetFlowPolicy(),
		"intersight_fabric_net_flow_record":                                  resourceFabricNetFlowRecord(),
		...
		"intersight_fabric_secure_router_role":                               resourceFabricSecureRouterRole(),
		"intersight_fabric_server_role":                                      resourceFabricServerRole(),
		"intersight_fabric_span_dest_eth_port":                               resourceFabricSpanDestEthPort(),
		"intersight_fabric_span_session":                                     resourceFabricSpanSession(),
		"intersight_fabric_span_source_eth_port":                             resourceFabricSpanSourceEthPort(),
		"intersight_fabric_span_source_eth_port_channel":                     resourceFabricSpanSourceEthPortChannel(),
		"intersight_fabric_span_source_vlan":                                 resourceFabricSpanSourceVlan(),
		"intersight_fabric_span_source_vnic_eth_if":                          resourceFabricSpanSourceVnicEthIf(),
		"intersight_fabric_switch_cluster_profile":                           resourceFabricSwitchClusterProfile(),
		"intersight_fabric_switch_cluster_profile_template":                  resourceFabricSwitchClusterProfileTemplate(),
		...
		"intersight_fabric_switch_profile_template":                          resourceFabricSwitchProfileTemplate(),
		...
		"intersight_firmware_pci_node_upgrade":                               resourceFirmwarePciNodeUpgrade(),
		"intersight_firmware_policy":                                         resourceFirmwarePolicy(),
		"intersight_firmware_secure_router_upgrade":                          resourceFirmwareSecureRouterUpgrade(),
		...
		"intersight_iam_cui_integration":                                     resourceIamCuiIntegration(),
		...
		"intersight_iam_guest_access_settings":                               resourceIamGuestAccessSettings(),
		...
		"intersight_iam_local_user_password":                                 resourceIamLocalUserPassword(),
		"intersight_iam_permission":                                          resourceIamPermission(),
		"intersight_iam_private_key_spec":                                    resourceIamPrivateKeySpec(),
		"intersight_iam_privilege_set":                                       resourceIamPrivilegeSet(),
		"intersight_iam_privilege_set_meta_info":                             resourceIamPrivilegeSetMetaInfo(),
		...
		"intersight_iam_user_qualifier":                                      resourceIamUserQualifier(),
		...
		"intersight_iwotenant_migrate":                                       resourceIwotenantMigrate(),
		"intersight_iwotenant_tenant_customization":                          resourceIwotenantTenantCustomization(),
		...
		"intersight_license_erp_license_count":                               resourceLicenseErpLicenseCount(),
		...
		"intersight_memory_policy":                                           resourceMemoryPolicy(),
		"intersight_metrics_metrics_exploration":                             resourceMetricsMetricsExploration(),
		"intersight_metrics_resource_configuration":                          resourceMetricsResourceConfiguration(),
		"intersight_mgmt_config_backup_file":                                 resourceMgmtConfigBackupFile(),
		"intersight_mgmt_config_backup_operation":                            resourceMgmtConfigBackupOperation(),
		"intersight_mgmt_config_operation_setting":                           resourceMgmtConfigOperationSetting(),
		"intersight_mgmt_config_restore_operation":                           resourceMgmtConfigRestoreOperation(),
		...
		"intersight_partnerintegration_metrics":                              resourcePartnerintegrationMetrics(),
		"intersight_partnerintegration_model":                                resourcePartnerintegrationModel(),
		"intersight_pool_id_mapping_policy":                                  resourcePoolIdMappingPolicy(),
		"intersight_power_policy":                                            resourcePowerPolicy(),
		"intersight_power_power_group":                                       resourcePowerPowerGroup(),
		...
		"intersight_resourcepool_qualification_policy":                       resourceResourcepoolQualificationPolicy(),
		"intersight_resourcepool_reservation":                                resourceResourcepoolReservation(),
		"intersight_rproxy_reverse_proxy":                                    resourceRproxyReverseProxy(),
		"intersight_scheduler_schedule_policy":                               resourceSchedulerSchedulePolicy(),
		"intersight_scheduler_task_schedule":                                 resourceSchedulerTaskSchedule(),
		"intersight_sdaaci_connection":                                       resourceSdaaciConnection(),
		"intersight_sdaaci_connection_detail":                                resourceSdaaciConnectionDetail(),
		...
		"intersight_server_diagnostic_status":                                resourceServerDiagnosticStatus(),
		"intersight_server_diagnostics":                                      resourceServerDiagnostics(),
		...
		"intersight_smtp_policy_test":                                        resourceSmtpPolicyTest(),
		...
		"intersight_software_hci_bundle_distributable":                       resourceSoftwareHciBundleDistributable(),
		"intersight_software_hci_distributable":                              resourceSoftwareHciDistributable(),
		...
		"intersight_task_catalyst_sdwan_scoped_inventory":                    resourceTaskCatalystSdwanScopedInventory(),
		"intersight_task_fabric_mos_scoped_inventory":                        resourceTaskFabricMosScopedInventory(),
		"intersight_task_hci_scoped_inventory":                               resourceTaskHciScopedInventory(),
		...
		"intersight_task_meraki_scoped_inventory":                            resourceTaskMerakiScopedInventory(),
		...
		"intersight_task_pure_flash_blade_scoped_inventory":                  resourceTaskPureFlashBladeScopedInventory(),
		...
		"intersight_vnic_vhba_template":                                      resourceVnicVhbaTemplate(),
		"intersight_vnic_vnic_template":                                      resourceVnicVnicTemplate(),
		"intersight_vrf_vrf":                                                 resourceVrfVrf(),
		"intersight_webhook_endpoint":                                        resourceWebhookEndpoint(),
		"intersight_webhook_schema":                                          resourceWebhookSchema(),
		...
		"intersight_workflow_ui_display_metadata":                            resourceWorkflowUiDisplayMetadata(),
		"intersight_workflow_variable":                                       resourceWorkflowVariable(),
		...
		"intersight_workload_blueprint":                                      resourceWorkloadBlueprint(),
