...
// GetDefaultClassId returns the default value "iam.Permission" of the ClassId field.
func (o *IamPermission) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "iam.Permission" of the ObjectType field.
func (o *IamPermission) GetDefaultObjectType() interface{} {
	return "iam.Permission"
}
...
func (o *IamPermission) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *IamPermission) GetResourceRolesOk() ([]IamResourceRolesRelationship, bool) {
	if o == nil || IsNil(o.ResourceRoles) {
		return nil, false
	}
...
func (o *IamPermission) SetSessionLimitsNil() {
...
func (o *IamPermission) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamPermissionWithoutEmbeddedStruct)
	if err == nil {
