...
// ConvergedinfraPodComplianceInfo The PodComplianceInfo object captures compliance information for a converged infrastructure pod, extending the base compliance details to include specific compliance assessments for the pod itself.    #### Purpose PodComplianceInfo provides a detailed view of the compliance status of a pod, highlighting areas that meet or deviate from established standards. This  supports comprehensive compliance management and helps identify non-compliant components.    #### Key Concepts - **Compliance Tracking:** Offers insights into the compliance status of the entire pod, facilitating proactive management and remediation.  - **Inheritance:** Leverages the base compliance details, extending them to encompass pod-specific compliance metrics.  - **Detailed Relationships:** Establishes connections with the pod and its components, enabling a holistic view of compliance across the infrastructure. - **Administrative Access:** Supports a range of privilege sets, allowing different levels of administrative interaction with compliance data.
