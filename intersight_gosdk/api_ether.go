...
func (r ApiGetEtherHostPortByMoidRequest) Select_(select_ string) ApiGetEtherHostPortByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherHostPortByMoidRequest) Expand(expand string) ApiGetEtherHostPortByMoidRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetEtherHostPortByMoidRequest) At(at string) ApiGetEtherHostPortByMoidRequest {
	r.at = &at
	return r
}
...
type ApiGetEtherInterSwitchPortByMoidRequest struct {
	ctx        context.Context
	ApiService *EtherApiService
	moid       string
	select_    *string
...
// Specifies a subset of properties to return.
func (r ApiGetEtherInterSwitchPortByMoidRequest) Select_(select_ string) ApiGetEtherInterSwitchPortByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherInterSwitchPortByMoidRequest) Expand(expand string) ApiGetEtherInterSwitchPortByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherInterSwitchPortByMoidRequest) At(at string) ApiGetEtherInterSwitchPortByMoidRequest {
	r.at = &at
	return r
}

func (r ApiGetEtherInterSwitchPortByMoidRequest) Execute() (*EtherInterSwitchPort, *http.Response, error) {
	return r.ApiService.GetEtherInterSwitchPortByMoidExecute(r)
}

/*
GetEtherInterSwitchPortByMoid Read a 'ether.InterSwitchPort' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiGetEtherInterSwitchPortByMoidRequest
*/
func (a *EtherApiService) GetEtherInterSwitchPortByMoid(ctx context.Context, moid string) ApiGetEtherInterSwitchPortByMoidRequest {
	return ApiGetEtherInterSwitchPortByMoidRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
// Execute executes the request
//
//	@return EtherInterSwitchPort
func (a *EtherApiService) GetEtherInterSwitchPortByMoidExecute(r ApiGetEtherInterSwitchPortByMoidRequest) (*EtherInterSwitchPort, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EtherInterSwitchPort
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EtherApiService.GetEtherInterSwitchPortByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ether/InterSwitchPorts/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetEtherInterSwitchPortListRequest struct {
	ctx         context.Context
	ApiService  *EtherApiService
	filter      *string
	orderby     *string
...
// Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
func (r ApiGetEtherInterSwitchPortListRequest) Filter(filter string) ApiGetEtherInterSwitchPortListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetEtherInterSwitchPortListRequest) Orderby(orderby string) ApiGetEtherInterSwitchPortListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetEtherInterSwitchPortListRequest) Top(top int32) ApiGetEtherInterSwitchPortListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetEtherInterSwitchPortListRequest) Skip(skip int32) ApiGetEtherInterSwitchPortListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetEtherInterSwitchPortListRequest) Select_(select_ string) ApiGetEtherInterSwitchPortListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherInterSwitchPortListRequest) Expand(expand string) ApiGetEtherInterSwitchPortListRequest {
	r.expand = &expand
	return r
}

// Specify one or more transformation operations to perform aggregation on the resources. The transformations are processed in order with the output from a transformation being used as input for the subsequent transformation. The \&quot;$apply\&quot; query takes a sequence of set transformations, separated by forward slashes to express that they are consecutively applied, i.e., the result of each transformation is the input to the next transformation. Supported aggregation methods are \&quot;aggregate\&quot; and \&quot;groupby\&quot;. The **aggregate** transformation takes a comma-separated list of one or more aggregate expressions as parameters and returns a result set with a single instance, representing the aggregated value for all instances in the input set. The **groupby** transformation takes one or two parameters and 1. Splits the initial set into subsets where all instances in a subset have the same values for the grouping properties specified in the first parameter, 2. Applies set transformations to each subset according to the second parameter, resulting in a new set of potentially different structure and cardinality, 3. Ensures that the instances in the result set contain all grouping properties with the correct values for the group, 4. Concatenates the intermediate result sets into one result set. A groupby transformation affects the structure of the result set.
func (r ApiGetEtherInterSwitchPortListRequest) Apply(apply string) ApiGetEtherInterSwitchPortListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetEtherInterSwitchPortListRequest) Count(count bool) ApiGetEtherInterSwitchPortListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetEtherInterSwitchPortListRequest) Inlinecount(inlinecount string) ApiGetEtherInterSwitchPortListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherInterSwitchPortListRequest) At(at string) ApiGetEtherInterSwitchPortListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetEtherInterSwitchPortListRequest) Tags(tags string) ApiGetEtherInterSwitchPortListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetEtherInterSwitchPortListRequest) Execute() (*EtherInterSwitchPortResponse, *http.Response, error) {
	return r.ApiService.GetEtherInterSwitchPortListExecute(r)
}

/*
GetEtherInterSwitchPortList Read a 'ether.InterSwitchPort' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetEtherInterSwitchPortListRequest
*/
func (a *EtherApiService) GetEtherInterSwitchPortList(ctx context.Context) ApiGetEtherInterSwitchPortListRequest {
	return ApiGetEtherInterSwitchPortListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return EtherInterSwitchPortResponse
func (a *EtherApiService) GetEtherInterSwitchPortListExecute(r ApiGetEtherInterSwitchPortListRequest) (*EtherInterSwitchPortResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EtherInterSwitchPortResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EtherApiService.GetEtherInterSwitchPortList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ether/InterSwitchPorts"
...
type ApiGetEtherLanPortByMoidRequest struct {
	ctx        context.Context
	ApiService *EtherApiService
	moid       string
	select_    *string
...
// Specifies a subset of properties to return.
func (r ApiGetEtherLanPortByMoidRequest) Select_(select_ string) ApiGetEtherLanPortByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherLanPortByMoidRequest) Expand(expand string) ApiGetEtherLanPortByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherLanPortByMoidRequest) At(at string) ApiGetEtherLanPortByMoidRequest {
	r.at = &at
	return r
}

func (r ApiGetEtherLanPortByMoidRequest) Execute() (*EtherLanPort, *http.Response, error) {
	return r.ApiService.GetEtherLanPortByMoidExecute(r)
}

/*
GetEtherLanPortByMoid Read a 'ether.LanPort' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiGetEtherLanPortByMoidRequest
*/
func (a *EtherApiService) GetEtherLanPortByMoid(ctx context.Context, moid string) ApiGetEtherLanPortByMoidRequest {
	return ApiGetEtherLanPortByMoidRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return EtherLanPort
func (a *EtherApiService) GetEtherLanPortByMoidExecute(r ApiGetEtherLanPortByMoidRequest) (*EtherLanPort, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EtherLanPort
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EtherApiService.GetEtherLanPortByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ether/LanPorts/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetEtherLanPortListRequest struct {
	ctx         context.Context
	ApiService  *EtherApiService
	filter      *string
	orderby     *string
...
// Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
func (r ApiGetEtherLanPortListRequest) Filter(filter string) ApiGetEtherLanPortListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetEtherLanPortListRequest) Orderby(orderby string) ApiGetEtherLanPortListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetEtherLanPortListRequest) Top(top int32) ApiGetEtherLanPortListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetEtherLanPortListRequest) Skip(skip int32) ApiGetEtherLanPortListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetEtherLanPortListRequest) Select_(select_ string) ApiGetEtherLanPortListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherLanPortListRequest) Expand(expand string) ApiGetEtherLanPortListRequest {
	r.expand = &expand
	return r
}

// Specify one or more transformation operations to perform aggregation on the resources. The transformations are processed in order with the output from a transformation being used as input for the subsequent transformation. The \&quot;$apply\&quot; query takes a sequence of set transformations, separated by forward slashes to express that they are consecutively applied, i.e., the result of each transformation is the input to the next transformation. Supported aggregation methods are \&quot;aggregate\&quot; and \&quot;groupby\&quot;. The **aggregate** transformation takes a comma-separated list of one or more aggregate expressions as parameters and returns a result set with a single instance, representing the aggregated value for all instances in the input set. The **groupby** transformation takes one or two parameters and 1. Splits the initial set into subsets where all instances in a subset have the same values for the grouping properties specified in the first parameter, 2. Applies set transformations to each subset according to the second parameter, resulting in a new set of potentially different structure and cardinality, 3. Ensures that the instances in the result set contain all grouping properties with the correct values for the group, 4. Concatenates the intermediate result sets into one result set. A groupby transformation affects the structure of the result set.
func (r ApiGetEtherLanPortListRequest) Apply(apply string) ApiGetEtherLanPortListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetEtherLanPortListRequest) Count(count bool) ApiGetEtherLanPortListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetEtherLanPortListRequest) Inlinecount(inlinecount string) ApiGetEtherLanPortListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherLanPortListRequest) At(at string) ApiGetEtherLanPortListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetEtherLanPortListRequest) Tags(tags string) ApiGetEtherLanPortListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetEtherLanPortListRequest) Execute() (*EtherLanPortResponse, *http.Response, error) {
	return r.ApiService.GetEtherLanPortListExecute(r)
}

/*
GetEtherLanPortList Read a 'ether.LanPort' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetEtherLanPortListRequest
*/
func (a *EtherApiService) GetEtherLanPortList(ctx context.Context) ApiGetEtherLanPortListRequest {
	return ApiGetEtherLanPortListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return EtherLanPortResponse
func (a *EtherApiService) GetEtherLanPortListExecute(r ApiGetEtherLanPortListRequest) (*EtherLanPortResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EtherLanPortResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EtherApiService.GetEtherLanPortList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ether/LanPorts"
...
// Specifies a subset of properties to return.
func (r ApiGetEtherNetworkPortByMoidRequest) Select_(select_ string) ApiGetEtherNetworkPortByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherNetworkPortByMoidRequest) Expand(expand string) ApiGetEtherNetworkPortByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherNetworkPortByMoidRequest) At(at string) ApiGetEtherNetworkPortByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetEtherPhysicalPortByMoidRequest) Select_(select_ string) ApiGetEtherPhysicalPortByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherPhysicalPortByMoidRequest) Expand(expand string) ApiGetEtherPhysicalPortByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherPhysicalPortByMoidRequest) At(at string) ApiGetEtherPhysicalPortByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetEtherPortChannelByMoidRequest) Select_(select_ string) ApiGetEtherPortChannelByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetEtherPortChannelByMoidRequest) Expand(expand string) ApiGetEtherPortChannelByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetEtherPortChannelByMoidRequest) At(at string) ApiGetEtherPortChannelByMoidRequest {
	r.at = &at
	return r
}
