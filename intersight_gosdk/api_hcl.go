...
type ApiGetHclDataImportLogByMoidRequest struct {
	ctx        context.Context
	ApiService *HclApiService
	moid       string
	select_    *string
...
func (r ApiGetHclDataImportLogByMoidRequest) Select_(select_ string) ApiGetHclDataImportLogByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclDataImportLogByMoidRequest) Expand(expand string) ApiGetHclDataImportLogByMoidRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetHclDataImportLogByMoidRequest) At(at string) ApiGetHclDataImportLogByMoidRequest {
	r.at = &at
	return r
}

func (r ApiGetHclDataImportLogByMoidRequest) Execute() (*HclDataImportLog, *http.Response, error) {
	return r.ApiService.GetHclDataImportLogByMoidExecute(r)
}

/*
GetHclDataImportLogByMoid Read a 'hcl.DataImportLog' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiGetHclDataImportLogByMoidRequest
*/
func (a *HclApiService) GetHclDataImportLogByMoid(ctx context.Context, moid string) ApiGetHclDataImportLogByMoidRequest {
	return ApiGetHclDataImportLogByMoidRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
// Execute executes the request
//
//	@return HclDataImportLog
func (a *HclApiService) GetHclDataImportLogByMoidExecute(r ApiGetHclDataImportLogByMoidRequest) (*HclDataImportLog, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *HclDataImportLog
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HclApiService.GetHclDataImportLogByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/hcl/DataImportLogs/{Moid}"
...
type ApiGetHclDataImportLogListRequest struct {
	ctx         context.Context
	ApiService  *HclApiService
	filter      *string
	orderby     *string
...
func (r ApiGetHclDataImportLogListRequest) Filter(filter string) ApiGetHclDataImportLogListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetHclDataImportLogListRequest) Orderby(orderby string) ApiGetHclDataImportLogListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetHclDataImportLogListRequest) Top(top int32) ApiGetHclDataImportLogListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetHclDataImportLogListRequest) Skip(skip int32) ApiGetHclDataImportLogListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetHclDataImportLogListRequest) Select_(select_ string) ApiGetHclDataImportLogListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclDataImportLogListRequest) Expand(expand string) ApiGetHclDataImportLogListRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetHclDataImportLogListRequest) Apply(apply string) ApiGetHclDataImportLogListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetHclDataImportLogListRequest) Count(count bool) ApiGetHclDataImportLogListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetHclDataImportLogListRequest) Inlinecount(inlinecount string) ApiGetHclDataImportLogListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclDataImportLogListRequest) At(at string) ApiGetHclDataImportLogListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetHclDataImportLogListRequest) Tags(tags string) ApiGetHclDataImportLogListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetHclDataImportLogListRequest) Execute() (*HclDataImportLogResponse, *http.Response, error) {
	return r.ApiService.GetHclDataImportLogListExecute(r)
}

/*
GetHclDataImportLogList Read a 'hcl.DataImportLog' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetHclDataImportLogListRequest
*/
func (a *HclApiService) GetHclDataImportLogList(ctx context.Context) ApiGetHclDataImportLogListRequest {
	return ApiGetHclDataImportLogListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *HclApiService) GetHclDataImportLogListExecute(r ApiGetHclDataImportLogListRequest) (*HclDataImportLogResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *HclDataImportLogResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HclApiService.GetHclDataImportLogList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/hcl/DataImportLogs"
...
// Specifies a subset of properties to return.
func (r ApiGetHclDriverImageByMoidRequest) Select_(select_ string) ApiGetHclDriverImageByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclDriverImageByMoidRequest) Expand(expand string) ApiGetHclDriverImageByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclDriverImageByMoidRequest) At(at string) ApiGetHclDriverImageByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclExemptedCatalogByMoidRequest) Select_(select_ string) ApiGetHclExemptedCatalogByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclExemptedCatalogByMoidRequest) Expand(expand string) ApiGetHclExemptedCatalogByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclExemptedCatalogByMoidRequest) At(at string) ApiGetHclExemptedCatalogByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclHwCatalogInfoByMoidRequest) Select_(select_ string) ApiGetHclHwCatalogInfoByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclHwCatalogInfoByMoidRequest) Expand(expand string) ApiGetHclHwCatalogInfoByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclHwCatalogInfoByMoidRequest) At(at string) ApiGetHclHwCatalogInfoByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclHyperflexSoftwareCompatibilityInfoByMoidRequest) Select_(select_ string) ApiGetHclHyperflexSoftwareCompatibilityInfoByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclHyperflexSoftwareCompatibilityInfoByMoidRequest) Expand(expand string) ApiGetHclHyperflexSoftwareCompatibilityInfoByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclHyperflexSoftwareCompatibilityInfoByMoidRequest) At(at string) ApiGetHclHyperflexSoftwareCompatibilityInfoByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclOperatingSystemByMoidRequest) Select_(select_ string) ApiGetHclOperatingSystemByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclOperatingSystemByMoidRequest) Expand(expand string) ApiGetHclOperatingSystemByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclOperatingSystemByMoidRequest) At(at string) ApiGetHclOperatingSystemByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclOperatingSystemVendorByMoidRequest) Select_(select_ string) ApiGetHclOperatingSystemVendorByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclOperatingSystemVendorByMoidRequest) Expand(expand string) ApiGetHclOperatingSystemVendorByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclOperatingSystemVendorByMoidRequest) At(at string) ApiGetHclOperatingSystemVendorByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclServerCatalogByMoidRequest) Select_(select_ string) ApiGetHclServerCatalogByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclServerCatalogByMoidRequest) Expand(expand string) ApiGetHclServerCatalogByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclServerCatalogByMoidRequest) At(at string) ApiGetHclServerCatalogByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetHclServerHwCatalogInfoByMoidRequest) Select_(select_ string) ApiGetHclServerHwCatalogInfoByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetHclServerHwCatalogInfoByMoidRequest) Expand(expand string) ApiGetHclServerHwCatalogInfoByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetHclServerHwCatalogInfoByMoidRequest) At(at string) ApiGetHclServerHwCatalogInfoByMoidRequest {
	r.at = &at
	return r
}
