...
// checks if the ResourceMembershipList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceMembershipList{}
...
func (o ResourceMembershipList) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceMembershipList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varResourceMembershipListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varResourceMembershipList)
	if err == nil {
