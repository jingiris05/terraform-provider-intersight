...
// GetDefaultClassId returns the default value "fcpool.FcBlock" of the ClassId field.
func (o *FcpoolFcBlock) GetDefaultClassId() interface{} {
	return "fcpool.FcBlock"
}
...
// GetDefaultObjectType returns the default value "fcpool.FcBlock" of the ObjectType field.
func (o *FcpoolFcBlock) GetDefaultObjectType() interface{} {
	return "fcpool.FcBlock"
}

// GetIdBlock returns the IdBlock field value if set, zero value otherwise.
func (o *FcpoolFcBlock) GetIdBlock() FcpoolBlock {
	if o == nil || IsNil(o.IdBlock) {
		var ret FcpoolBlock
		return ret
	}
	return *o.IdBlock
...
func (o *FcpoolFcBlock) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o FcpoolFcBlock) ToMap() (map[string]interface{}, error) {
...
func (o *FcpoolFcBlock) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFcpoolFcBlockWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFcpoolFcBlock)
	if err == nil {
