...
// checks if the SessionAbstractSubSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionAbstractSubSession{}
...
type SessionAbstractSubSession struct {
	...
	Session              NullableSessionAbstractSessionRelationship `json:"Session,omitempty"`
	Target               NullableMoBaseMoRelationship               `json:"Target,omitempty"`
...
// SetSession gets a reference to the given NullableSessionAbstractSessionRelationship and assigns it to the Session field.
...
func (o *SessionAbstractSubSession) SetSessionNil() {
	o.Session.Set(nil)
}
...
// SetTarget gets a reference to the given NullableMoBaseMoRelationship and assigns it to the Target field.
func (o *SessionAbstractSubSession) SetTarget(v MoBaseMoRelationship) {
	o.Target.Set(&v)
}

// SetTargetNil sets the value for Target to be an explicit nil
func (o *SessionAbstractSubSession) SetTargetNil() {
	o.Target.Set(nil)
}
...
func (o *SessionAbstractSubSession) SetUserNil() {
	o.User.Set(nil)
}
...
func (o SessionAbstractSubSession) ToMap() (map[string]interface{}, error) {
...
func (o *SessionAbstractSubSession) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSessionAbstractSubSessionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSessionAbstractSubSession)
	if err == nil {
