...
// checks if the StorageBaseReplicationBlackout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageBaseReplicationBlackout{}
...
// GetDefaultClassId returns the default value "storage.PureReplicationBlackout" of the ClassId field.
func (o *StorageBaseReplicationBlackout) GetDefaultClassId() interface{} {
	return "storage.PureReplicationBlackout"
}
...
// GetDefaultObjectType returns the default value "storage.PureReplicationBlackout" of the ObjectType field.
func (o *StorageBaseReplicationBlackout) GetDefaultObjectType() interface{} {
	return "storage.PureReplicationBlackout"
}
...
func (o StorageBaseReplicationBlackout) ToMap() (map[string]interface{}, error) {
...
func (o *StorageBaseReplicationBlackout) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageBaseReplicationBlackoutWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageBaseReplicationBlackout)
	if err == nil {
