...
// WorkflowCatalog The Catalog object serves as a container for organizing definitions related to orchestration, including both workflow, task definitions and more. #### Purpose It provides a structured way to manage and isolate orchestration assets. Each user account has a local catalog for private definitions, while Cisco provides shared catalogs containing validated workflows and tasks for use within the account context. #### Key Concepts - **Asset Organization:** Groups workflow and task definitions for better discovery and management. - **Access Context:** Supports both private account-level catalogs and shared, Cisco-managed catalogs. - **Namespace Management:** Ensures unique identification of orchestration assets within the organizational context.
