...
type FirmwareRunningFirmware struct {
	...
	EquipmentPsu              NullableEquipmentPsuRelationship              `json:"EquipmentPsu,omitempty"`
...
// GetEquipmentPsu returns the EquipmentPsu field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FirmwareRunningFirmware) GetEquipmentPsu() EquipmentPsuRelationship {
	if o == nil || IsNil(o.EquipmentPsu.Get()) {
		var ret EquipmentPsuRelationship
		return ret
	}
	return *o.EquipmentPsu.Get()
}

// GetEquipmentPsuOk returns a tuple with the EquipmentPsu field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetEquipmentPsu gets a reference to the given NullableEquipmentPsuRelationship and assigns it to the EquipmentPsu field.
func (o *FirmwareRunningFirmware) SetEquipmentPsu(v EquipmentPsuRelationship) {
	o.EquipmentPsu.Set(&v)
}

// SetEquipmentPsuNil sets the value for EquipmentPsu to be an explicit nil
func (o *FirmwareRunningFirmware) SetEquipmentPsuNil() {
	o.EquipmentPsu.Set(nil)
}
...
func (o FirmwareRunningFirmware) ToMap() (map[string]interface{}, error) {
	...
	if o.EquipmentPsu.IsSet() {
		toSerialize["EquipmentPsu"] = o.EquipmentPsu.Get()
	}
...
func (o *FirmwareRunningFirmware) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFirmwareRunningFirmware.EquipmentPsu = varFirmwareRunningFirmwareWithoutEmbeddedStruct.EquipmentPsu
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "EquipmentPsu")
