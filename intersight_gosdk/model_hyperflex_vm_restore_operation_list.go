...
// checks if the HyperflexVmRestoreOperationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexVmRestoreOperationList{}
...
func (o HyperflexVmRestoreOperationList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexVmRestoreOperationList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexVmRestoreOperationListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexVmRestoreOperationList)
	if err == nil {
