...
// checks if the NiatelemetryImageDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryImageDetail{}
...
// GetDefaultClassId returns the default value "niatelemetry.ImageDetail" of the ClassId field.
func (o *NiatelemetryImageDetail) GetDefaultClassId() interface{} {
	return "niatelemetry.ImageDetail"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.ImageDetail" of the ObjectType field.
func (o *NiatelemetryImageDetail) GetDefaultObjectType() interface{} {
	return "niatelemetry.ImageDetail"
}
...
func (o NiatelemetryImageDetail) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryImageDetail) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryImageDetailWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryImageDetail)
	if err == nil {
