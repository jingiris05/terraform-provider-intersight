...
// checks if the VirtualizationBaseDistributedNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationBaseDistributedNetwork{}
...
func NewVirtualizationBaseDistributedNetwork(classId string, objectType string) *VirtualizationBaseDistributedNetwork {
...
func (o VirtualizationBaseDistributedNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationBaseDistributedNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseDistributedNetworkWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseDistributedNetwork)
	if err == nil {
