...
// checks if the NetworkVpcPeerList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkVpcPeerList{}
...
func (o NetworkVpcPeerList) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkVpcPeerList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNetworkVpcPeerListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNetworkVpcPeerList)
	if err == nil {
