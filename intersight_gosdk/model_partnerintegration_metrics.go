...
// PartnerintegrationMetrics The Metrics object defines how platform API outputs are translated into the Intersight Metrics format. #### Purpose It allows for the transformation of raw platform metrics into a standardized format, enabling consistent monitoring and analysis across different storage or networking platforms. #### Key Concepts - **Metric Transformation:** Maps platform-specific metrics to the Intersight Metrics model. - **Standardization:** Ensures that metrics are represented consistently, regardless of the source platform.
