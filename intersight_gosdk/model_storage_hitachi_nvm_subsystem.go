...
// StorageHitachiNvmSubsystem The HitachiNvmSubsystem object represents an NVM subsystem entity within the Hitachi storage array, providing functionalities for managing NVMe-oF connections and subsystems. #### Purpose HitachiNvmSubsystem serves as a critical component for managing NVM subsystems, supporting operations related to subsystem settings, security configurations, and namespace management. #### Key Concepts - **Subsystem Management:** Provides settings for subsystem IDs, security configurations, and namespace management within NVMe-oF connections. - **Privilege Sets:** Ensures controlled access for managing NVM subsystem configurations with defined privilege sets. - **Licensing:** Operates under specified entitlements, supporting authorized operations.
