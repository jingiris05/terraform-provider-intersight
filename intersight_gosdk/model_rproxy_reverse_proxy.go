...
// checks if the RproxyReverseProxy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RproxyReverseProxy{}

// RproxyReverseProxy The ReverseProxy object serves as a pivotal element within the network infrastructure, enabling the implementation of REST API endpoints for reverse proxy operations. It is responsible for processing API requests and directing them to Terraform Cloud based on the credentials in Terrform Cloud target. #### Purpose The ReverseProxy object is designed to efficiently manage and forward API requests. It acts as an intermediary, fetching necessary credentials from targets and ensuring seamless redirection to Terraform Cloud. #### Key Concepts - **Credential Management:** Ensures the retrieval of appropriate credentials before request forwarding. - **Target-Based Routing:** Determines the routing of requests based on specified target types.
...
// GetDefaultClassId returns the default value "rproxy.ReverseProxy" of the ClassId field.
func (o *RproxyReverseProxy) GetDefaultClassId() interface{} {
	return "rproxy.ReverseProxy"
}
...
// GetDefaultObjectType returns the default value "rproxy.ReverseProxy" of the ObjectType field.
func (o *RproxyReverseProxy) GetDefaultObjectType() interface{} {
	return "rproxy.ReverseProxy"
}
...
func (o *RproxyReverseProxy) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o RproxyReverseProxy) ToMap() (map[string]interface{}, error) {
...
func (o *RproxyReverseProxy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRproxyReverseProxyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varRproxyReverseProxy)
	if err == nil {
