...
func (r ApiGetCloudTfcAgentpoolByMoidRequest) Select_(select_ string) ApiGetCloudTfcAgentpoolByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetCloudTfcAgentpoolByMoidRequest) Expand(expand string) ApiGetCloudTfcAgentpoolByMoidRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetCloudTfcAgentpoolByMoidRequest) At(at string) ApiGetCloudTfcAgentpoolByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetCloudTfcOrganizationByMoidRequest) Select_(select_ string) ApiGetCloudTfcOrganizationByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetCloudTfcOrganizationByMoidRequest) Expand(expand string) ApiGetCloudTfcOrganizationByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetCloudTfcOrganizationByMoidRequest) At(at string) ApiGetCloudTfcOrganizationByMoidRequest {
	r.at = &at
	return r
}
...
// Specifies a subset of properties to return.
func (r ApiGetCloudTfcWorkspaceByMoidRequest) Select_(select_ string) ApiGetCloudTfcWorkspaceByMoidRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetCloudTfcWorkspaceByMoidRequest) Expand(expand string) ApiGetCloudTfcWorkspaceByMoidRequest {
	r.expand = &expand
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetCloudTfcWorkspaceByMoidRequest) At(at string) ApiGetCloudTfcWorkspaceByMoidRequest {
	r.at = &at
	return r
}
