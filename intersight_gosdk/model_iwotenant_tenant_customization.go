...
// IwotenantTenantCustomization ### Overview The TenantCustomization object allows end-users to tailor their IWO tenant configurations, enhancing functionality through options like enabling data extractors. #### Purpose The TenantCustomization object provides mechanisms for users to customize their tenant environments, offering flexibility in data handling and feature management.  #### Key Concepts - **Data Management:** - Enables the activation of data extractors, facilitating reporting and analysis within the tenant's namespace. - **Customization Flexibility:** - Provides options for users to enhance tenant capabilities according to their specific requirements. - **Account Linkage:** - Maintains associations with relevant accounts and tenants, ensuring consistent customization across linked entities.
