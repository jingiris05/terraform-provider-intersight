...
// checks if the StorageHitachiArrayUtilization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageHitachiArrayUtilization{}
...
// GetDefaultClassId returns the default value "storage.HitachiArrayUtilization" of the ClassId field.
func (o *StorageHitachiArrayUtilization) GetDefaultClassId() interface{} {
	return "storage.HitachiArrayUtilization"
}
...
// GetDefaultObjectType returns the default value "storage.HitachiArrayUtilization" of the ObjectType field.
func (o *StorageHitachiArrayUtilization) GetDefaultObjectType() interface{} {
	return "storage.HitachiArrayUtilization"
}
...
func (o StorageHitachiArrayUtilization) ToMap() (map[string]interface{}, error) {
...
func (o *StorageHitachiArrayUtilization) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageHitachiArrayUtilizationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageHitachiArrayUtilization)
	if err == nil {
