...
// checks if the BulkApiResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkApiResult{}
...
func (o *BulkApiResult) GetDefaultClassId() interface{} {
...
func (o *BulkApiResult) GetDefaultObjectType() interface{} {
	return "bulk.RestResult"
}
...
func (o BulkApiResult) ToMap() (map[string]interface{}, error) {
...
func (o *BulkApiResult) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBulkApiResultWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBulkApiResult)
	if err == nil {
