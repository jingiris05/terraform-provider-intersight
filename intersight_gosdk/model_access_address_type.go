...
// checks if the AccessAddressType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessAddressType{}
...
// GetDefaultClassId returns the default value "access.AddressType" of the ClassId field.
func (o *AccessAddressType) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "access.AddressType" of the ObjectType field.
func (o *AccessAddressType) GetDefaultObjectType() interface{} {
	return "access.AddressType"
}
...
func (o AccessAddressType) ToMap() (map[string]interface{}, error) {
...
func (o *AccessAddressType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAccessAddressTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAccessAddressType)
	if err == nil {
