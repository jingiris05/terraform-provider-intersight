...
type ComputePhysical struct {
	...
	// The actual front panel state of the server. * `Unlock` - Front Panel of the server is set to Unlocked state. * `Lock` - Front Panel of the server is set to Locked state.
	...
	RecoveryKeyDetails NullableComputeRecoveryKeyDetails `json:"RecoveryKeyDetails,omitempty"`
...
// GetRecoveryKeyDetails returns the RecoveryKeyDetails field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ComputePhysical) GetRecoveryKeyDetails() ComputeRecoveryKeyDetails {
	if o == nil || IsNil(o.RecoveryKeyDetails.Get()) {
		var ret ComputeRecoveryKeyDetails
		return ret
	}
	return *o.RecoveryKeyDetails.Get()
}

// GetRecoveryKeyDetailsOk returns a tuple with the RecoveryKeyDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetRecoveryKeyDetails gets a reference to the given NullableComputeRecoveryKeyDetails and assigns it to the RecoveryKeyDetails field.
func (o *ComputePhysical) SetRecoveryKeyDetails(v ComputeRecoveryKeyDetails) {
	o.RecoveryKeyDetails.Set(&v)
}

// SetRecoveryKeyDetailsNil sets the value for RecoveryKeyDetails to be an explicit nil
func (o *ComputePhysical) SetRecoveryKeyDetailsNil() {
	o.RecoveryKeyDetails.Set(nil)
}
...
func (o ComputePhysical) ToMap() (map[string]interface{}, error) {
	...
	if o.RecoveryKeyDetails.IsSet() {
		toSerialize["RecoveryKeyDetails"] = o.RecoveryKeyDetails.Get()
	}
...
func (o *ComputePhysical) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varComputePhysical.RecoveryKeyDetails = varComputePhysicalWithoutEmbeddedStruct.RecoveryKeyDetails
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "RecoveryKeyDetails")
