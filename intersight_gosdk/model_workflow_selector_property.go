...
// checks if the WorkflowSelectorProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowSelectorProperty{}
...
// GetDefaultClassId returns the default value "workflow.SelectorProperty" of the ClassId field.
func (o *WorkflowSelectorProperty) GetDefaultClassId() interface{} {
	return "workflow.SelectorProperty"
}
...
// GetDefaultObjectType returns the default value "workflow.SelectorProperty" of the ObjectType field.
func (o *WorkflowSelectorProperty) GetDefaultObjectType() interface{} {
	return "workflow.SelectorProperty"
}
...
func (o WorkflowSelectorProperty) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowSelectorProperty) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowSelectorPropertyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowSelectorProperty)
	if err == nil {
